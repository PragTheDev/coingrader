...
const backgroundOptions = [
  ...
  },
  {
    ...
    icon: Stars,
    preview:
      "bg-gradient-to-br from-sky-200 via-blue-300 to-cyan-200 dark:from-indigo-900 dark:via-purple-900 dark:to-pink-800",
  },
  {
    id: "grid",
    name: "Grid Pattern",
  ...
  },
  {
    ...
    icon: Waves,
    preview:
      "bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900",
  },
  {
    id: "sparkles",
    ...
    icon: Sparkles,
    preview:
      "bg-gradient-to-br from-purple-50 via-pink-50 to-rose-100 dark:from-purple-900 dark:via-pink-900 dark:to-rose-900",
  },
];
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {backgroundOptions.map((option) => (
                  <div
                    key={option.id}
                    className={`relative cursor-pointer rounded-xl border-2 transition-all duration-300 glass ${
                  ...
                  >
                    {/* Preview */}
                    <div
                      className={`h-24 rounded-t-xl ${option.preview} relative overflow-hidden`}
                    >
              ...
              <div className="mt-6 p-4 bg-blue-50/50 dark:bg-blue-900/20 rounded-xl border border-blue-200/50 dark:border-blue-700/50 glass">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      Background changes will be applied immediately. Animated
                      backgrounds may affect performance on older devices.
                    </p>
                  </div>
                </div>
              </div>
